...
public class Logicos extends javax.swing.JInternalFrame {
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        ...
        try{
        double num1= Double.parseDouble(this.tfNum1.getText());
        double num2= Double.parseDouble(this.tfNum2.getText());
        ...
        else JOptionPane.showMessageDialog(this, "No son iguales", "Respuesta", JOptionPane.WARNING_MESSAGE);
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        // TODO add your handling code here:
        try{
        double num1= Double.parseDouble(this.tfNum3.getText());
        double num2= Double.parseDouble(this.tfNum4.getText());
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        // TODO add your handling code here:
          ...
          try{
        double num1= Double.parseDouble(this.tfNum5.getText());
        double num2= Double.parseDouble(this.tfNum6.getText());
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        ...
        try{
        double num1= Double.parseDouble(this.tfNum7.getText());
        double num2= Double.parseDouble(this.tfNum8.getText());
        boolean resp= logico.esMayor(num1, num2);
        if (resp) JOptionPane.showMessageDialog(this, "Si es mayor o igual", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
        else JOptionPane.showMessageDialog(this, "No es mayor o igual", "Respuesta", JOptionPane.WARNING_MESSAGE);
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        // TODO add your handling code here:
        try{
        double num1= Double.parseDouble(this.tfNum9.getText());
        double num2= Double.parseDouble(this.tfNum10.getText());
        boolean resp= logico.esMenor(num1, num2);
        if (resp) JOptionPane.showMessageDialog(this, "Si es menor o igual", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
        else JOptionPane.showMessageDialog(this, "No es menoro igual", "Respuesta", JOptionPane.WARNING_MESSAGE);
    ...
    private void bVerificar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar7ActionPerformed
        ...
        if (resp) JOptionPane.showMessageDialog(this, "No son iguales", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular9ActionPerformed
        ...
        boolean resp= logico.cadenasMayores(cadena1, cadena2);
        if (resp) JOptionPane.showMessageDialog(this, "La primer cadena es mayor", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
        else JOptionPane.showMessageDialog(this, " La segunda cadena es mayor", "Respuesta", JOptionPane.WARNING_MESSAGE);
    ...
    private void bVerificar10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar10ActionPerformed
        // TODO add your handling code here:
         try{
        double num1= Double.parseDouble(this.tfNum11.getText());
        boolean resp= logico.positivoOnegativo(num1);
        if (resp) JOptionPane.showMessageDialog(this, "Es positivo", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
        else JOptionPane.showMessageDialog(this, " Es negativo", "Respuesta", JOptionPane.WARNING_MESSAGE);
