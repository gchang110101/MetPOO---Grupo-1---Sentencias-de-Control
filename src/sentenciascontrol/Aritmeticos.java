...
public class Aritmeticos extends javax.swing.JInternalFrame {
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        ...
        try{
            ...
            double resp = aritmetico.sonMultiplos(num1, num2);
          if(resp==0){
              JOptionPane.showMessageDialog(this, "Es multiplo",
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        ...
        try{
            ...
            double num3 = Double.parseDouble(this.tfNum5.getText());
            double num4 = Double.parseDouble(this.tfNum6.getText());
            double num5 = Double.parseDouble(this.tfNum7.getText());
            double resp = aritmetico.calcularExpresion1(num1, num2, num3, num4, num5);
            
                JOptionPane.showMessageDialog(this, "El resultado es: "+resp, 
                        "Respuesta",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        // TODO add your handling code here:
        try{
            double num1 = Double.parseDouble(this.tfNum8.getText());
            double num2 = Double.parseDouble(this.tfNum9.getText());
            double num3 = Double.parseDouble(this.tfNum10.getText());
            double num4 = Double.parseDouble(this.tfNum11.getText());
            double num5 = Double.parseDouble(this.tfNum12.getText());
            double resp = aritmetico.calcularExpresion2(num1, num2, num3, num4, num5);
